...
class DirectSQLGenerator(SQLGenerator):
    """
    A class to generate SQL queries directly from a given prompt, without any additional steps.
    ...
    def __init__(
        ...
        # Default database schema for the DirectSQLGenerator
        ...
        """
        Initializes the DirectSQLGenerator.
        ...
        Args:
            ...
            sql_gen_prompt_format (str): The template for the SQL generation prompt.
                                        It should have placeholders like {schema} and {instructions}.
            sql_gen_task (str): The description of the SQL generation task.
            sql_gen_context (str): Additional context for the SQL generation task.
            sql_gen_final_instructions (str): The final instructions for the SQL generation prompt.
        """
        self.model = model
    ...
    def get_dir_gen_prompt_content(self, 
                                   tables_list: List[str],
                                   ) -> str:
        """
    ...
    def generate_sql(self, query: str, tables_list: List[str],
        ...
        dir_gen_prompt = self.get_dir_gen_prompt_content(tables_list=tables_list)
        ...
        # else:
        #     # If only one completion is requested, take the response directly
        #     generated_sql = model_response
        #     # Format the SQL if requested
        #     generated_sql = extract_sql(generated_sql, format_sql=format_sql)
    ...
    def get_prompt(self, tables_list: List[str] = [""]) -> str:
        ...
        """
        return self.get_dir_gen_prompt_content(tables_list=tables_list)
    ...
    def get_prompts(self, tables_list: List[str] = [""]) -> Dict[str, Any]:
        ...
        return { 
            ...
            "final_instructions": self.sql_gen_final_instructions,
            "prompt": self.get_dir_gen_prompt_content(tables_list=tables_list)
        }
